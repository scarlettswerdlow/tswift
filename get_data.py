...
def build_dfs(album_ids, headers, verbose):
    ...
    for album_id in album_ids:
        ...
        track_ids = get_album_tracks(album_id, headers)

        for track_id in track_ids:
            
            track_data = get_track_data(track_id, headers)
...
def main(config_fp, album_fp, tracks_fp, verbose):
    ...
    album_df, track_df = build_dfs(TSWIFT_ALBUM_IDS, headers, verbose)
